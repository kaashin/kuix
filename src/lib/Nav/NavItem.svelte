<script>
  export let title = "Nav Item";
  export let path = "#";
  export let active = false;
</script>

{#if active} 
<a href={path} class="bg-gray-900 text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md">
...
{:else}
<a href={path} class="text-gray-300 hover:bg-gray-700 hover:text-white group flex items-center px-2 py-2 text-base font-medium rounded-md">
